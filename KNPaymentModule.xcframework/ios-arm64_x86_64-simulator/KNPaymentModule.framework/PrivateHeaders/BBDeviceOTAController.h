...
typedef NS_ENUM (NSUInteger, BBDeviceOTAResult) {
    BBDeviceOTAResult_Success = 0,
    BBDeviceOTAResult_SetupError = 1,
    BBDeviceOTAResult_BatteryLowError = 2,
    BBDeviceOTAResult_DeviceCommError = 3,
    BBDeviceOTAResult_ServerCommError = 4,
    BBDeviceOTAResult_Failed = 5,
    BBDeviceOTAResult_Stopped = 6,
    BBDeviceOTAResult_NoUpdateRequired = 7,
    BBDeviceOTAResult_InvalidControllerStateError = 8,
    BBDeviceOTAResult_IncompatibleFirmwareHex = 9,
    BBDeviceOTAResult_IncompatibleConfigHex = 10,
};
