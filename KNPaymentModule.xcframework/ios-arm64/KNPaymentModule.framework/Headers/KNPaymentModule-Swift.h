...
#ifndef KNPAYMENTMODULE_SWIFT_H
#define KNPAYMENTMODULE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="KNPaymentModule",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


/// Main class to manage general functionality of each reader
SWIFT_CLASS("_TtC15KNPaymentModule12KNBaseReader")
@interface KNBaseReader : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


/// Bbpos Reader Implementation
SWIFT_CLASS("_TtC15KNPaymentModule13KNBbposReader")
@interface KNBbposReader : KNBaseReader
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
- (void)onBTConnected:(NSObject * _Nonnull)connectedDevice;
...
- (void)onReturnCheckCardResult:(BBDeviceCheckCardResult)result cardData:(NSDictionary * _Nonnull)cardData;
- (void)onReturnTransactionResult:(BBDeviceTransactionResult)result;
- (void)onRequestOnlineProcess:(NSString * _Nonnull)tlv;
...
/// </ul>
IB_DESIGNABLE
SWIFT_CLASS("_TtC15KNPaymentModule19YPDrawSignatureView")
