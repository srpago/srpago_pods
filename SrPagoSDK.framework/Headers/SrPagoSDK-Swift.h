...
#ifndef SRPAGOSDK_SWIFT_H
#define SRPAGOSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SrPagoSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9SrPagoSDK10Connection")
...
SWIFT_CLASS("_TtC9SrPagoSDK17ConnectionRequest")
...
SWIFT_CLASS("_TtC9SrPagoSDK15LocationService")
...
SWIFT_CLASS("_TtC9SrPagoSDK7Payment")
@interface Payment : NSObject
- (nonnull instancetype)initWithAmount:(float)amount reference:(NSString * _Nonnull)reference OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
- (void)setupWithAppKey:(NSString * _Nonnull)appKey appSecret:(NSString * _Nonnull)appSecret;
- (void)makeRefundWithTransactionId:(NSString * _Nonnull)transactionId completion:(void (^ _Nonnull)(NSString * _Nonnull))completion error:(void (^ _Nonnull)(NSError * _Nonnull))error;
@end


SWIFT_CLASS("_TtC9SrPagoSDK11SrUtilities")
